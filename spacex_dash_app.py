...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                html.Div(dcc.RangeSlider(id='payload-slider',min=0, max=10000, step=1000,marks={0: '0', 2500: '2500',5000:'5000',7500:'7500',10000:'10000'},
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        data = spacex_df.loc[spacex_df["Launch Site"]== entered_site].groupby(["Launch Site","class"]).size().reset_index(name='count')
        fig = px.pie(data, values='count', names='class', title='Total Success Launches for site '+entered_site)
        return fig
# TASK 4:
